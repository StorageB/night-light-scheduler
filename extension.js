...
export default class PlainExampleExtension extends Extension {
    ...
    enable() {
        ...
        this._scheduleChangedId =
            this._extensionSettings.connect("changed::schedule", () => {
                this._scheduleNext();
            });
    ...
    _scheduleNext() {
        ...
        for (let entry of schedule) {
            ...
            if (entryMinutes <= currentMinutes)
                ...
                nextMinutes = entryMinutes;
        }

        if (nextMinutes === null) nextMinutes = schedule[0].hour * 60 + schedule[0].minute + 1440;

        const secondsUntilNext = Math.max(1, (nextMinutes - currentMinutes) * 60 - currentSeconds);
